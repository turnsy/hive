  ...
  (
    ...
    return (
      ...
      >
        <ContextMenu>
          <ContextMenuTrigger>
            <AccordionPrimitive.Trigger
              className={cn(
                `flex items-center gap-1 text-md rounded-md`,
                className,
                {
        ...
        <AccordionPrimitive.Content className="text-md data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down relative overflow-hidden h-full">
        ...
        <ContextMenu>
          <ContextMenuTrigger>
            <AccordionPrimitive.Trigger
              ...
              aria-label="File"
              className={cn(
                "flex items-center gap-1 cursor-pointer text-md pr-1 rtl:pl-1 rtl:pr-0 rounded-md  duration-200 ease-in-out",
                {
